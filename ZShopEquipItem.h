...
protected:
	...
	IShopEquipItemHandle_Sell*			m_pHandlerSac;
...
public:
	...
	void SetHandleSac(IShopEquipItemHandle_Sell* p)			{ m_pHandlerSac = p; }
	...
	IShopEquipItemHandle_Sell* GetHandleSac()					{ return m_pHandlerSac; }
...
class ZShopEquipItemHandle_SacGamble : public IShopEquipItemHandle_Sell, public IItemCountDlgDoneHandler
{
	ZShopEquipItem_Gamble* m_pItem;
public:
	ZShopEquipItemHandle_SacGamble(ZShopEquipItem_Gamble* pItem);
	virtual bool GetPrice(int& out_nPrice);
	virtual void Sell();
...
class ZShopEquipItemHandle_SacMatch : public IShopEquipItemHandle_Sell, public ISimpleConfirmDlgDoneHandler, public IItemCountDlgDoneHandler, public ISellCashItemConfirmDlgDoneHandler
{
	ZShopEquipItem_Match* m_pItem;
public:
	ZShopEquipItemHandle_SacMatch(ZShopEquipItem_Match* pItem);
	virtual bool GetPrice(int& out_nPrice);
	virtual void Sell();
	virtual void OnDone(int nCount) { return; }
	virtual void OnConfirmSellCashItem(bool bOk) { return; }
	virtual void OnDone(bool bOk);
};
...
class ZShopEquipItemHandle_SacQuest : public IShopEquipItemHandle_Sell, public IItemCountDlgDoneHandler
{
	ZShopEquipItem_Quest* m_pItem;
public:
	ZShopEquipItemHandle_SacQuest(ZShopEquipItem_Quest* pItem);
	virtual bool GetPrice(int& out_nPrice);
	virtual void Sell();
