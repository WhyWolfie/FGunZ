...
#endif
		// Custom: Disable return false and force event set, because:
		// In some instances, you can specify the WININET_API_FLAG_ASYNC flag, 
		// and the function returns successfully. 
		// You will only receive a INTERNET_STATUS_REQUEST_COMPLETE notification in your callback 
		// if the function fails and GetLastError returns ERROR_IO_PENDING. 
		// If the function call returns successfully, you do not receive an INTERNET_STATUS_REQUEST_COMPLETE notification. 
