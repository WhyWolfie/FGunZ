...
public:
	...
	//Custom: Module log.
	bool LogCharModules(const int nAID, const char* nModule, const char* MMD5);
	...
	bool BringAccountItem(const int nAID, const int nCID, const int nAIID, unsigned long int* poutCIID, 
		unsigned long int* poutItemID, bool* poutIsRentItem, int* poutRentMinutePeriodRemainder, WORD& wRentHourPeriod, int* nRarity, int* niLevel );
	bool BringAccountItemStackable(const int nAID, const int nCID, const int nAIID, const int nCount, const int nCIID, unsigned long int* poutCIID, 
		unsigned long int* poutItemID, bool* poutIsRentItem, int* poutRentMinutePeriodRemainder, unsigned int* poutCount, WORD& wRentHourPeriod, int* nRarity, int* niLevel );
	...
	bool InsertDistributeItem(const unsigned int nCID, int nItemDescID, bool bRentItem, int nRentPeriodHour, int nRarity, int niLevel, unsigned long int* poutCIID);
	...
	bool GetCWOption( int nCLID, int* poutOption );
	bool UpdateCWOption( int nCLID, int nOption );
