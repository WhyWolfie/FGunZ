...
protected:
	...
	void DeathCount()				{ m_nDeathCount++; m_nAllRoundDeathCount++; /*m_nKillstreak = 0;*/ }
	void KillCount()				{ m_nKillCount++; m_nAllRoundKillCount++; m_nKillstreak++; }
...
public:
	...
	unsigned int GetKillstreak()	{ return m_nKillstreak; }
	void SetKillstreak(unsigned int nKillstreak) { m_nKillstreak = nKillstreak; }
