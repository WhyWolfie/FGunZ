...
#ifdef _DEBUG
#pragma comment ( lib, "../../sdk/UnitTest++/lib/UnitTest++.vsnet2010d.lib")
#else
#pragma comment ( lib, "../../sdk/UnitTest++/lib/UnitTest++.vsnet2010.lib")
#endif
...
bool RunUnitTest()
{
	...
	// This is the proper function that does it
