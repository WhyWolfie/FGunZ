...
ZItemSlotView* ZIDLResource::GetItemSlot(MXmlElement& element)
{
	...
	//Custom: Avatar Clothing Slot, well, slots.
	else if (!stricmp(szParts, "avatarhead"))		pWidget->SetParts(MMCIP_AVATAR_HEAD);
	else if (!stricmp(szParts, "avatarchest"))		pWidget->SetParts(MMCIP_AVATAR_CHEST);
	else if (!stricmp(szParts, "avatarhands"))	pWidget->SetParts(MMCIP_AVATAR_HANDS);
	else if (!stricmp(szParts, "avatarlegs"))	pWidget->SetParts(MMCIP_AVATAR_LEGS);
	else if (!stricmp(szParts, "avatarfeet"))	pWidget->SetParts(MMCIP_AVATAR_FEET);
