...
struct ServerInfo
{
	...
	char	szAgentIP[ 32];
	int		nPeerPort; // Custom: MatchServer UDP Port
};
...
public:
	...
	bool AddServer( char* szName, char* szAddress, int nPort, int nType, int nNumOfUser, int nCapacity, bool IsLive, char* szAgentIP="", int nRow=0, int nCol=0, int nPeerPort=7777);
